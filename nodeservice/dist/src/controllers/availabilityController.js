...
exports.getCourseAvailability =
  exports.updateAvailability =
  exports.getTutorAvailability =
    void 0;
    ...
    try {
      ...
      [
        ...
        const dayAvailability =
          (_a = tutor.availability) === null || _a === void 0
            ? void 0
            : _a.days.find((d) => d.day === day.toUpperCase());
...
const getCourseAvailability = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      ...
      const startDate = (0, date_fns_1.startOfDay)(
      ...
      for (
        ...
        const dayAvailability =
          (_a = course.tutor.availability) === null || _a === void 0
            ? void 0
            : _a.days.find((d) => d.day === dayOfWeek);
        if (dayAvailability) {
          ...
          const slots = generateAvailableTimeSlots({
            ...
            dateStr,
            timeGap:
              (_b = course.tutor.availability) === null || _b === void 0
                ? void 0
                : _b.timeGap,
          });
          availableDates.push({
...
function generateAvailableTimeSlots({
  ...
  const slots = [];
  let currentTime = (0, date_fns_1.parseISO)(
    `${dateStr}T${startTime.toISOString().slice(11, 16)}:00.000Z`
  );
  const slotEndTime = (0, date_fns_1.parseISO)(
